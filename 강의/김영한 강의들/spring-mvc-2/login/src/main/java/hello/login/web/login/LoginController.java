...
//    @PostMapping("/login")
//    public String loginV3(@Validated @ModelAttribute LoginForm loginForm, BindingResult bindingResult,
...
//        //로그인 성공 처리
//        //세션 관리자를 통해 세션을 생성하고, 회원데이터 보관
//        HttpSession session = request.getSession(true); //세션이 있으면 반환, 없으면 생성
